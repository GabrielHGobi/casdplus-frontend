      ...
      <Overlay
        ...
        <View style={styles.stylesContainer}>
          <TouchableOpacity
            ...
            style={[styles.tipoContainer, { backgroundColor: "#D1FEBC" }]}>
          ...
          <TouchableOpacity
            ...
            style={[styles.tipoContainer, { backgroundColor: "#FFC5B2" }]}>
        ...
        <View style={styles.stylesContainer}>
          <TouchableOpacity
            ...
            style={[styles.tipoContainer, { backgroundColor: "#F9B342" }]}>
          ...
          <TouchableOpacity
            ...
            style={[styles.tipoContainer, { backgroundColor: "#B4B2FF" }]}>
        ...
        <View style={styles.stylesContainer}>
          <TouchableOpacity
            ...
            style={[styles.tipoContainer, { backgroundColor: "#FF6431" }]}>
          ...
          <TouchableOpacity
            ...
            style={[styles.tipoContainer, { backgroundColor: "#45ECCE" }]}>
